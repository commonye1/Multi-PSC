...
int main()
{
  ...
  // NTL::ZZ des1, des2, det1, det2, testplain1, testplain2;
  // Steven.getDe_partial(Spair[Tindex].fir, des1);
  // Tom.getDe_partial(Spair[Tindex].fir, det1);
  // Steven.getDe_partial(Tpair[Sindex].fir, des2);
  // Tom.getDe_partial(Tpair[Sindex].fir, det2);
  // Steven.Decrypt(testplain1, Spair[Tindex].sec, des1, det1);
  // Tom.Decrypt(testplain2, Tpair[Sindex].sec, des2, det2);
  ...
  // NTL::ZZ des1, des2, det1, det2, testplain1, testplain2;
  // Steven.getDe_partial(cs_x.fir, des1);
  // Tom.getDe_partial(cs_x.fir, det1);
  // Steven.getDe_partial(ct_y.fir, des2);
  // Tom.getDe_partial(ct_y.fir, det2);
  // Steven.Decrypt(testplain1, cs_x.sec, des1, det1);
  // Tom.Decrypt(testplain2, ct_y.sec, des2, det2);
  ...
  // NTL::ZZ des1, des2, det1, det2, testplain1, testplain2;
  // Steven.getDe_partial(cs1.fir, des1);
  // Tom.getDe_partial(cs1.fir, det1);
  // Steven.getDe_partial(ct1.fir, des2);
  // Tom.getDe_partial(ct1.fir, det2);
  // Steven.Decrypt(testplain1, cs1.sec, des1, det1);
  // Tom.Decrypt(testplain2, ct1.sec, des2, det2);
  // cout << "Fdsfsfsdf" << endl;
